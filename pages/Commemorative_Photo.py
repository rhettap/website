...
st.markdown('''
### If you want, let's start by taking a commemorative photo together! (Make sure to get up close to the camera)
''')
...
image_path1 = 'website/my_image1.jpg'
image_path2 = 'website/my_image2.jpg'
...
def concatenate_images(image1, image2, image3):
    ...
    concatenated_image = Image.new("RGB", (img1.width + img2.width +img3.width, img1.height))
    concatenated_image.paste(img1, (0, 0))
    concatenated_image.paste(img2, (img1.width,0) )
    concatenated_image.paste(img3, (img1.width +img2.width, 0))
...
if st.session_state["photo"] == "Done":
    if camera_photo is not None:
        ...
        # Concatenate images
        result_image = concatenate_images(my_image1, uploaded_file_path, my_image2)
